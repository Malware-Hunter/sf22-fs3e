...
do
    ...
    echo "python3 -m methods.SigAPI.main -d $DATASET -o $OUT_FILENAME -i $INCREMENT"
    { time python3 -m methods.SigAPI.main -d $DATASET -o $OUT_FILENAME -i $INCREMENT; } 2> time_$OUT_FILENAME.txt
done
